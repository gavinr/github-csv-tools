...
| -a, --exportAttributes | number, title, labels (Multiple labels should be comma separated), state, assignees, milestone, comments, created_at, updated_at, closed_at, body | Comma-separated list of attributes (columns) in the export**.                                                                                                                                                 |
